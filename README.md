...
* **aggregateAttrCertClaims**: whether to aggregate claims from attribute certificates into the top-level idpClaims (otherwise they are available as attributeCertClaims)
